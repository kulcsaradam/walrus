        ...
        for (auto &variable : variableRange) {
            ...
            for (auto elem : getMap) {
                ...
                while (true) {
                    ...
                    if (closestSet == variable.sets.end()) {
                        break;
                    }
                    ...
                    if (closestLabel->first < *closestSet) {
                        if (closestLabel->second.byteCodeOffset > *closestSet) {
                            pos = closestLabel->first;
                            // closestSet->second = true;
                        } else {
                            if (*closestSet == elem.first) {
                                // variable.needsInit = true;
                            }
